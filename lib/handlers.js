...
handlers.fb_leadgen_webhook = (data, callback) => {
  ...
  const access_token = 'EAAD5ZBICBhXkBAJgvRkAe2dcRZAfLGNu2ZC2ZCCJgBs2be7wZCfprttSso41meIxDAan2TSmXrbUSFHsgVu6mhNdwUA6t9c9iXzkS018F8XBZAgtfiGUp0BP2ePxDZCET84FVwTsKO335aqjZChVsAE4QiVyhoCIwO8ZD';
  ...
  var getOptions = {
    ...
    "path": `/v3.2/${formId}/leads?access_token=${access_token}`
  };
  ...
  var req = http.request(getOptions, function (res) {
    ...
    res.on("end", function () {
      ...
      if(jsonResponse.data) {
        // const leadGenEmail = jsonResponse.data[0].field_data[0][0].values[0];
        // const leadGenFirstName = jsonResponse.data[0].field_data[0][1].values[0];
        // const leadGenLastName = jsonResponse.data[0].field_data[0][2].values[0];

        console.log(jsonResponse.data);
        //console.log('Email : ', leadGenEmail, ' First Name : ', leadGenFirstName, ' Last Name: ', leadGenLastName);
      }
    });
  });
